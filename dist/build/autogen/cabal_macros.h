...
/* package cogs-0.1.0.0 */
#define VERSION_cogs "0.1.0.0"
#define MIN_VERSION_cogs(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "cogs-0.1.0.0-Guj2Qr6w7QO3SF7vn6F1RW"

#define CURRENT_PACKAGE_KEY "cogs-0.1.0.0-Guj2Qr6w7QO3SF7vn6F1RW"
